        ...
        <div className="mt-12 sm:mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {d.realisations.map((r) => (
            <button
              ...
              className="hover-card group text-left relative gradient-violet-border rounded-2xl p-6 glow-violet reveal cursor-pointer"
            >
              <div className="aspect-[16/9] rounded-xl mb-5 relative overflow-hidden bg-gradient-to-br from-[hsl(var(--violet-700))] via-[hsl(var(--violet-500))] to-[hsl(var(--violet-400))]">
                <div className="absolute inset-0 grid-bg-fx opacity-40" />
              ...
              <h3 className="font-display text-xl font-semibold text-white mb-1 flex items-start justify-between gap-3">
          ...
          <div
            ...
            className="hover-card reveal rounded-2xl p-6 border-2 border-dashed border-[hsl(var(--violet-500)/0.3)] flex flex-col items-center justify-center min-h-[260px] sm:min-h-[280px] text-center"
          >
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription className="text-[hsl(var(--text-secondary))] pt-2">
                  Le contenu détaillé de cette réalisation sera ajouté prochainement.
                </DialogDescription>
              </DialogHeader>
              {active.status && (
                <div className="mt-2 p-4 rounded-xl bg-[hsl(var(--bg-base))] border border-[hsl(var(--violet-500)/0.25)]">
                  <span className="inline-flex items-center gap-1.5 text-xs font-mono text-[hsl(var(--violet-300))]">
                    <Clock size={12} />
