  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto reveal">
        <div className="gradient-violet-border rounded-3xl p-8 sm:p-12 glow-violet-strong relative overflow-hidden">
          ...
          <div className="relative z-10 grid md:grid-cols-[1fr_auto] gap-8 items-center">
            <div>
              ...
              <h2 className="font-display mt-5 text-3xl sm:text-4xl font-bold text-white">
